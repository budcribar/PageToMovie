...
| Finish file | `cut.project.json` (trims / range-deletes / split windows / joins / cards / text clips / text style / music name) |
...
| 7h | Play one merged file (no take hops / no black flash) | **This PR** |
