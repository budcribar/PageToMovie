...
{
    /// <summary>
    /// Size only establishes that bytes exist. Playability is decided by the
    /// browser decoder and, during compose, by decoding the selected range.
    /// </summary>
    public static bool IsCandidateFile(long sizeBytes) => sizeBytes > 0;
